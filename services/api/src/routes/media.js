...
// No eager default router: index.js calls buildMediaRouter() itself, and an
// import-time default would construct a second provider (and its OpenAI
// client) on every boot for nothing.
