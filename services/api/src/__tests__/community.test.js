    ...
    prisma._store.entity.push(
      {
        ...
        data: { title: 'Rated plan', is_public: true, status: 'active' }, createdAt: new Date(), updatedAt: new Date(),
      },
      {
        id: 'legacy-email-plan-rating', type: 'SharedPlanRating', userId: 'u-legacy-plan-rating',
        data: { plan_id: 'legacy-rated-plan', user_id: 'u-legacy-plan-rating', user_name: 'legacy-plan-rating@example.com', rating: 5 },
        createdAt: new Date(), updatedAt: new Date(),
      },
    );
